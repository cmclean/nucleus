...
This class provides wrappers for conveniently interacting with protos defined in
struct.proto, mostly ListValue and Value objects. It should primarily be used by
variant_utils and variantcallutils rather than being used directly.
...
`value`: The int value(s) to append to the field. This can be a single int or a
list of ints.
...
`value`: The number value(s) to append to the field. This can be a single number
...
`value`: The string value(s) to append to the field. This can be a single string
...
`is_single_field`: bool. If True, return the first bool value stored (it should
be the only one in the field). Otherwise, return the list of bools.
...
`is_single_field`: bool. If True, return the first int value stored (it should
be the only one in the field). Otherwise, return the list of ints.
...
should be the only one in the field). Otherwise, return the list of numbers.
...
should be the only one in the field). Otherwise, return the list of strings.
...
`value`: The boolean value(s) to set the field to. This can be a single boolean
...
`value`: The int value(s) to set the field to. This can be a single int or a
list of ints.
...
`value`: The number value(s) to set the field to. This can be a single number or
a list of numbers.
...
`value`: The int value(s) to set the field to. This can be a single string or a
list of strings.
